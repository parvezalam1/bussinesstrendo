  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <div className='flex lg:flex-row flex-col w-full'>
        ...
        {/* right */}
        <div className='per p-2 lg:w-2/4 w-full flex justify-center items-center gap-3 flex-wrap transition-all hover:rotate-x-90 origin-center'>
          {/* cards */}
          <div className="cardbox w-72 h-52">
            <div className='card relative rounded-md lg:flex-shrink-0 lg:flex-grow-0 flex-shrink flex-grow
            shadow-sm shadow-gray-300 hover:shadow-current'>
              <div className="front">
                <Image
              ...
              {/* text */}
              <div className="back">
                <span className='block p-2 w-72 h-52 justify-center items-center rounded-md lg:flex-shrink-0 lg:flex-grow-0 flex-shrink flex-grow'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo sunt commodi minima
          ...
          <div className="cardbox w-72 h-52">
            ...
            shadow-sm shadow-gray-300 hover:shadow-current'>
              <div className="front">
                <Image
                  className='rounded-md'
                  src={'https://cdn.pixabay.com/photo/2020/12/16/15/19/mobile-phone-5836879_640.png'} fill alt='' />
              </div>
              {/* text */}
              <div className="back">
                <span className='block p-2 w-72 h-52 justify-center items-center rounded-md lg:flex-shrink-0 lg:flex-grow-0 flex-shrink flex-grow'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo sunt commodi minima
          ...
          <div className="cardbox w-72 h-52">
            ...
            shadow-sm shadow-gray-300 hover:shadow-current'>
              <div className="front">
                <Image
                  className='rounded-md'
                  src={'https://cdn.pixabay.com/photo/2018/05/17/15/10/social-3408791_640.jpg'} fill alt='' />
              </div>
              {/* text */}
              <div className="back">
                <span className='block p-2 w-72 h-52 justify-center items-center rounded-md lg:flex-shrink-0 lg:flex-grow-0 flex-shrink flex-grow'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo sunt commodi minima
          ...
          <div className="cardbox w-72 h-52">
            ...
            shadow-sm shadow-gray-300 hover:shadow-current'>
              <div className="front">
                <Image
                  className='rounded-md'
                  src={'https://cdn.pixabay.com/photo/2018/03/12/02/00/seo-3218580_640.jpg'} fill alt='' />
              </div>
              {/* text */}
              <div className="back">
                <span className='block p-2 w-72 h-52 justify-center items-center rounded-md lg:flex-shrink-0 lg:flex-grow-0 flex-shrink flex-grow'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo sunt commodi minima
